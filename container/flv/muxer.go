...
import (
	...
	"github.com/chwjbn/livesrv/utils/pio"
...
func (f *FlvDvr) GetWriter(info av.Info) av.WriteCloser {
	...
	glog.Info("new flv dvr: ", writer.Info())
	return writer
}
